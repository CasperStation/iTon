<div align="center">
  ...
  <h3 align="center">iTon 15 Website</h3>
...
This is a clone of Apple's iTon 15 Pro website using React.js and TailwindCSS. It highlights the effective use of GSAP (Greensock Animations) and Three.js for displaying iTon 15 Pro models in various colors and shapes.
...
👉 **3D Model Rendering with Different Colors and Sizes**: Explore the iTon 15 Pro from every angle with dynamic 3D rendering, offering various color and size options.
...
export const navLists = ["Store", "Mac", "iTon", "Support"];
...
export const models = [
  {
    id: 1,
    title: "iTon 15 Pro in Natural Titanium",
    color: ["#8F8A81", "#ffe7b9", "#6f6c64"],
    img: yellowImg,
  },
  {
    id: 2,
    title: "iTon 15 Pro in Blue Titanium",
    color: ["#53596E", "#6395ff", "#21242e"],
    img: blueImg,
  },
  {
    id: 3,
    title: "iTon 15 Pro in White Titanium",
    color: ["#C9C8C2", "#ffffff", "#C9C8C2"],
    img: whiteImg,
  },
  {
    id: 4,
    title: "iTon 15 Pro in Black Titanium",
